    ...
    public void sendWelcomeEmail(String to, String userName) {
        ...
        try {
            ...
            String htmlContent = "<html><body style='font-family: Arial, sans-serif; background-color: #0f172a; color: #ffffff; padding: 40px;'>" +
                    ...
                    "<a href='http://localhost:5173/login' style='background: #8b5cf6; color: white; padding: 15px 35px; border-radius: 12px; text-decoration: none; font-weight: 900; box-shadow: 0 10px 20px rgba(139, 92, 246, 0.3);'>LAUNCH PORTAL 🚀</a>" +
                    "</div>" +
                    "</div>" +
